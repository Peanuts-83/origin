...
INSERT INTO Espece VALUES (1,'Chien','Canis canis','Bestiole à quatre pattes qui aime les caresses et tire souvent la langue',250),(2,'Chat','Felis silvestris','Bestiole à quatre pattes qui saute très haut et grimpe aux arbres',150),(3,'Tortue d''Hermann','Testudo hermanni','Bestiole avec une carapace très dure',200),
(4,'Perroquet amazone','Alipiopsitta xanthops','Joli oiseau parleur vert et jaune',500),(5,'Rat','Ratus fourbus','Petit rongeur adepte de nos égouts',120);
UNLOCK TABLES;
...
INSERT INTO Race VALUES (1,'Berger allemand',1,'Chien sportif et élégant au pelage dense, noir-marron-fauve, noir ou gris.',300),(2,'Berger blanc suisse',1,'Petit chien au corps compact, avec des pattes courtes mais bien proportionnées et au pelage tricolore ou bicolore.',450),
(3,'Singapura',2,'Chat de petite taille aux grands yeux en amandes.',200),(4,'Bleu russe',2,'Chat aux yeux verts et à la robe épaisse et argentée.',350),(5,'Maine coon',2,'Chat de grande taille, à poils mi-longs.',700),
(7,'Sphynx',2,'Chat sans poils.',850),(8,'Nebelung',2,'Chat bleu russe, mais avec des poils longs...',400);
UNLOCK TABLES;
